export const days = [
  {
    ...
    stops: [
      ...
      { id: 101, name: "PHX Phoenix Layover", lat: 33.4373, lng: -112.0078, placeId: null, type: "transport", notes: "3h 17m layover. Arrive 11:58am, depart 3:15pm. Vegan options: Sips (tamales) · Cartel Coffee Lab (poblano & rice burrito) · Humble Pie (vegan cheese pizza) · Wildflower (a few options) · Los Taquitos (tacos/burritos made vegan) · Sir Veza's (tacos/bowls/burritos vegan by request) · SanTan in T3 (beyond burger w/ vegan cheese) · Pedal Haus Brewery (pizza w/ vegan cheese)." },
